...
<body>
    ...
    <section id="contact">
        ...
        <div class="contact-list">
            ...
            <div class="contact-item"><i data-feather="mail"></i><a href="mailto:byouqet@gmail.com">Email</a></div>
        </div>
    </section>
    <div class="footer">
    ...
    document.getElementById('contactForm').addEventListener('submit', function(event) {
            ...
            var whatsappUrl =
                `https: //wa.me/62881026484748?text=Nama:%20${encodeURIComponent(name)}%0AEmail:%20${encodeURIComponent(email)}%0APesan:%20${encodeURIComponent(message)}`;
