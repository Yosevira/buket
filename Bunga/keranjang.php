...
<body>
    <div class="cart-container">
        ...
        <div class="cart-items">
            ...
            <div class="cart-item">
                <img src="foto/<?= htmlspecialchars($item['image']); ?>" altrs<?= htmlspecialchars($item['name']); ?>">
                ...
                <div class="cart-item-actions">
                    <!-- Tombol Ubah Jumlah -->
                    <input type="number" class="update-quantity" data-index="<?= $index; ?>" min="1"
        ...
        <div class="cart-buttons">
            <button id="back-button" class="back-button" onclick="window.location.href='menu.php'">Kembali Ke
                Menu</button>
